...
class Talkino_Agent_Manager {
	...
	public function query_agent_data() {
		...
		while ( $loop->have_posts() ) :
			...
			if ( false === $is_agent_schedule_activate_status_on || ( true === $is_agent_schedule_online_status && true === $is_agent_schedule_activate_status_on ) ) {
	 ...
	 * @since     1.0.0
	 *
	 * @return    string    The output of facebook.
	 */
