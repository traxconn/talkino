...
?>
	<div class="talkino-options-section">
		<p>
			<label><b><?php esc_html_e( 'Online Schedule:', 'talkino' ); ?></b></label>
		<br>
			<label><i><?php esc_html_e( 'Configure the online schedule for the agent. Please be noted that global online schedule in Talkino Settings will override the online schedule for the agent.', 'talkino' ); ?></i></label>
		</p>
		<p>			
		<!-- Agent schedule time activate status field -->
		<input name="talkino_agent_schedule_activate_status" type="hidden" value='off' />
		<input id="talkino_agent_schedule_activate_status" name="talkino_agent_schedule_activate_status" type="checkbox" <?php echo esc_attr( $is_agent_schedule_activate_status_checked ); ?> value='on' /> <?php esc_html_e( 'Activate the online schedule feature for agent', 'talkino' ); ?>
		</p>
		...
		<input id="talkino-agent-schedule-monday-online-status" name="talkino_agent_schedule_monday_online_status" type="checkbox" <?php echo esc_attr( $is_monday_checked ); ?> value='on' /> <?php esc_html_e( 'Monday', 'talkino' ); ?>
		<p>
			<select name="talkino_agent_schedule_monday_start_time">
			<?php
				$talkino_utility_manager->select_time( $data['agent_schedule_monday_start_time'] );
			?>
			</select>

			<select name="talkino_agent_schedule_monday_end_time">
			<?php
				$talkino_utility_manager->select_time( $data['agent_schedule_monday_end_time'] );
			?>
			</select>
		</p>
		...
		<input id="talkino-agent-schedule-tuesday-online-status" name="talkino_agent_schedule_tuesday_online_status" type="checkbox" <?php echo esc_attr( $is_tuesday_checked ); ?> value='on' /> <?php esc_html_e( 'Tuesday', 'talkino' ); ?>
		<p>
			<select name="talkino_agent_schedule_tuesday_start_time">
			<?php
				$talkino_utility_manager->select_time( $data['agent_schedule_tuesday_start_time'] );
			?>
			</select>

			<select name="talkino_agent_schedule_tuesday_end_time">
			<?php
				$talkino_utility_manager->select_time( $data['agent_schedule_tuesday_end_time'] );
			?>
			</select>
		</p>
		...
		<input id="talkino-agent-schedule-wednesday-online-status" name="talkino_agent_schedule_wednesday_online_status" type="checkbox" <?php echo esc_attr( $is_wednesday_checked ); ?> value='on' /> <?php esc_html_e( 'Wednesday', 'talkino' ); ?>
		<p>
			<select name="talkino_agent_schedule_wednesday_start_time">
			<?php
				$talkino_utility_manager->select_time( $data['agent_schedule_wednesday_start_time'] );
			?>
			</select>

			<select name="talkino_agent_schedule_wednesday_end_time">
			<?php
				$talkino_utility_manager->select_time( $data['agent_schedule_wednesday_end_time'] );
			?>
			</select>
		</p>
		...
		<input id="talkino-agent-schedule-thursday-online-status" name="talkino_agent_schedule_thursday_online_status" type="checkbox" <?php echo esc_attr( $is_thursday_checked ); ?> value='on' /> <?php esc_html_e( 'Thursday', 'talkino' ); ?>
		<p>
			<select name="talkino_agent_schedule_thursday_start_time">
			<?php
				$talkino_utility_manager->select_time( $data['agent_schedule_thursday_start_time'] );
			?>
			</select>

			<select name="talkino_agent_schedule_thursday_end_time">
			<?php
				$talkino_utility_manager->select_time( $data['agent_schedule_thursday_end_time'] );
			?>
			</select>
		</p>
		...
		<input id="talkino-agent-schedule-friday-online-status" name="talkino_agent_schedule_friday_online_status" type="checkbox" <?php echo esc_attr( $is_friday_checked ); ?> value='on' /> <?php esc_html_e( 'Friday', 'talkino' ); ?>
		<p>
			<select name="talkino_agent_schedule_friday_start_time">
			<?php
				$talkino_utility_manager->select_time( $data['agent_schedule_friday_start_time'] );
			?>
			</select>

			<select name="talkino_agent_schedule_friday_end_time">
			<?php
				$talkino_utility_manager->select_time( $data['agent_schedule_friday_end_time'] );
			?>
			</select>
		</p>
		...
		<input id="talkino-agent-schedule-saturday-online-status" name="talkino_agent_schedule_saturday_online_status" type="checkbox" <?php echo esc_attr( $is_saturday_checked ); ?> value='on' /> <?php esc_html_e( 'Saturday', 'talkino' ); ?>
		<p>
			<select name="talkino_agent_schedule_saturday_start_time">
			<?php
				$talkino_utility_manager->select_time( $data['agent_schedule_saturday_start_time'] );
			?>
			</select>

			<select name="talkino_agent_schedule_saturday_end_time">
			<?php
				$talkino_utility_manager->select_time( $data['agent_schedule_saturday_end_time'] );
			?>
			</select>
		</p>
		...
		<input id="talkino-agent-schedule-sunday-online-status" name="talkino_agent_schedule_sunday_online_status" type="checkbox" <?php echo esc_attr( $is_sunday_checked ); ?> value='on' /> <?php esc_html_e( 'Sunday', 'talkino' ); ?>
		<p>
			<select name="talkino_agent_schedule_sunday_start_time">
			<?php
				$talkino_utility_manager->select_time( $data['agent_schedule_sunday_start_time'] );
			?>
			</select>

			<select name="talkino_agent_schedule_sunday_end_time">
			<?php
				$talkino_utility_manager->select_time( $data['agent_schedule_sunday_end_time'] );
			?>
			</select>
		</p>
		...
		<p>
			<button type="button" class="button button-primary" name="talkino_agent_schedule_selector" id="talkino-agent-schedule-selector" /><?php esc_html_e( 'Select all days', 'talkino' ); ?></button>
		</p>
	</div>
