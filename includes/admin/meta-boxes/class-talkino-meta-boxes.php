...
class Talkino_Meta_Boxes {
    ...
    public function save_meta_box( $post_id, $post ) {
        ...
        // Verify nonce.
        if( ! isset( $_POST['talkino_chatbox_nonce'] ) || ! wp_verify_nonce( $_POST['talkino_chatbox_nonce'], basename( __FILE__ ) ) ) {
            return $post_id;
        }
        ...
        $job_title = ( isset( $_POST['talkino_job_title'] ) ) ? sanitize_text_field( $_POST['talkino_job_title'] ) : '';
        $whatsapp_id = ( isset( $_POST['talkino_whatsapp_id'] ) ) ? $talkino_sanitizer->sanitize_whatsapp_phone_number( $_POST['talkino_whatsapp_id'] ): '';
        $whatsapp_pre_filled_message = ( isset( $_POST['talkino_whatsapp_pre_filled_message'] ) ) ? sanitize_text_field( $_POST['talkino_whatsapp_pre_filled_message'] ): '';
        $facebook_id = ( isset( $_POST['talkino_facebook_id'] ) ) ? sanitize_text_field( $_POST['talkino_facebook_id'] ): '';
        ...
        $agent_schedule_monday_online_status = ( isset( $_POST['talkino_agent_schedule_monday_online_status'] ) ) ? $talkino_sanitizer->sanitize_agent_schedule_online_status( $_POST['talkino_agent_schedule_monday_online_status'] ) : 'off';
        $agent_schedule_monday_start_time =   ( isset( $_POST['talkino_agent_schedule_monday_start_time'] ) ) ? $talkino_sanitizer->sanitize_agent_schedule_time( $_POST['talkino_agent_schedule_monday_start_time'] ) : '00:00';
        $agent_schedule_monday_end_time =  ( isset( $_POST['talkino_agent_schedule_monday_end_time'] ) ) ? $talkino_sanitizer->sanitize_agent_schedule_time( $_POST['talkino_agent_schedule_monday_end_time'] ) : '23:30';
        
        $agent_schedule_tuesday_online_status = ( isset( $_POST['talkino_agent_schedule_tuesday_online_status'] ) ) ? $talkino_sanitizer->sanitize_agent_schedule_online_status( $_POST['talkino_agent_schedule_tuesday_online_status'] ) : 'off';
        $agent_schedule_tuesday_start_time =   ( isset( $_POST['talkino_agent_schedule_tuesday_start_time'] ) ) ? $talkino_sanitizer->sanitize_agent_schedule_time( $_POST['talkino_agent_schedule_tuesday_start_time'] ) : '00:00';
        $agent_schedule_tuesday_end_time =  ( isset( $_POST['talkino_agent_schedule_tuesday_end_time'] ) ) ? $talkino_sanitizer->sanitize_agent_schedule_time( $_POST['talkino_agent_schedule_tuesday_end_time'] ) : '23:30';
        
        $agent_schedule_wednesday_online_status = ( isset( $_POST['talkino_agent_schedule_wednesday_online_status'] ) ) ? $talkino_sanitizer->sanitize_agent_schedule_online_status( $_POST['talkino_agent_schedule_wednesday_online_status'] ) : 'off';
        $agent_schedule_wednesday_start_time =   ( isset( $_POST['talkino_agent_schedule_wednesday_start_time'] ) ) ? $talkino_sanitizer->sanitize_agent_schedule_time( $_POST['talkino_agent_schedule_wednesday_start_time'] ) : '00:00';
        $agent_schedule_wednesday_end_time =  ( isset( $_POST['talkino_agent_schedule_wednesday_end_time'] ) ) ? $talkino_sanitizer->sanitize_agent_schedule_time( $_POST['talkino_agent_schedule_wednesday_end_time'] ) : '23:30';
        
        $agent_schedule_thursday_online_status = ( isset( $_POST['talkino_agent_schedule_thursday_online_status'] ) ) ? $talkino_sanitizer->sanitize_agent_schedule_online_status( $_POST['talkino_agent_schedule_thursday_online_status'] ) : 'off';
        $agent_schedule_thursday_start_time =   ( isset( $_POST['talkino_agent_schedule_thursday_start_time'] ) ) ? $talkino_sanitizer->sanitize_agent_schedule_time( $_POST['talkino_agent_schedule_thursday_start_time'] ) : '00:00';
        $agent_schedule_thursday_end_time =  ( isset( $_POST['talkino_agent_schedule_thursday_end_time'] ) ) ? $talkino_sanitizer->sanitize_agent_schedule_time( $_POST['talkino_agent_schedule_thursday_end_time'] ) : '23:30';
        
        $agent_schedule_friday_online_status = ( isset( $_POST['talkino_agent_schedule_friday_online_status'] ) ) ? $talkino_sanitizer->sanitize_agent_schedule_online_status( $_POST['talkino_agent_schedule_friday_online_status'] ) : 'off';
        $agent_schedule_friday_start_time =   ( isset( $_POST['talkino_agent_schedule_friday_start_time'] ) ) ? $talkino_sanitizer->sanitize_agent_schedule_time( $_POST['talkino_agent_schedule_friday_start_time'] ) : '00:00';
        $agent_schedule_friday_end_time =  ( isset( $_POST['talkino_agent_schedule_friday_end_time'] ) ) ? $talkino_sanitizer->sanitize_agent_schedule_time( $_POST['talkino_agent_schedule_friday_end_time'] ) : '23:30';
        
        $agent_schedule_saturday_online_status = ( isset( $_POST['talkino_agent_schedule_saturday_online_status'] ) ) ? $talkino_sanitizer->sanitize_agent_schedule_online_status( $_POST['talkino_agent_schedule_saturday_online_status'] ) : 'off';
        $agent_schedule_saturday_start_time =   ( isset( $_POST['talkino_agent_schedule_saturday_start_time'] ) ) ? $talkino_sanitizer->sanitize_agent_schedule_time( $_POST['talkino_agent_schedule_saturday_start_time'] ) : '00:00';
        $agent_schedule_saturday_end_time =  ( isset( $_POST['talkino_agent_schedule_saturday_end_time'] ) ) ? $talkino_sanitizer->sanitize_agent_schedule_time( $_POST['talkino_agent_schedule_saturday_end_time'] ) : '23:30';
        
        $agent_schedule_sunday_online_status = ( isset( $_POST['talkino_agent_schedule_sunday_online_status'] ) ) ? $talkino_sanitizer->sanitize_agent_schedule_online_status( $_POST['talkino_agent_schedule_sunday_online_status'] ) : 'off';
        $agent_schedule_sunday_start_time =   ( isset( $_POST['talkino_agent_schedule_sunday_start_time'] ) ) ? $talkino_sanitizer->sanitize_agent_schedule_time( $_POST['talkino_agent_schedule_sunday_start_time'] ) : '00:00';
        $agent_schedule_sunday_end_time =  ( isset( $_POST['talkino_agent_schedule_sunday_end_time'] ) ) ? $talkino_sanitizer->sanitize_agent_schedule_time( $_POST['talkino_agent_schedule_sunday_end_time'] ) : '23:30';
