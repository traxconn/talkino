...
class Talkino_Sanitizer {
     ...
     * @return   string    $agent_schedule_online_status    The sanitized agent schedule online status.
     */
    public function sanitize_agent_schedule_online_status( $agent_schedule_online_status ) {

        if ( $agent_schedule_online_status == 'on' || $agent_schedule_online_status == 'off' ) {
     ...
     * @return   string    $agent_schedule_time    The sanitized agent schedule time.
     */
    public function sanitize_agent_schedule_time( $agent_schedule_time ) {
        ...
        // Monday field.
        if( in_array( $agent_schedule_time, $time_range ) ) {
